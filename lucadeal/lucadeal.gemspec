...
Gem::Specification.new do |spec|
  ...
  spec.description   =<<~DESC
   Deal with contracts
  DESC
  spec.homepage      = "https://github.com/chumaltd/luca/lucadeal"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/chumaltd/luca/lucadeal"
    spec.metadata["changelog_uri"] = "https://github.com/chumaltd/luca/lucadeal/CHANGELOG.md"
  else
